...
# np.load("D:/ML final project/PS_Battles/ps_battles_ela_X.npy")
# np.load("D:/ML final project/PS_Battles/ps_battles_ela_Y.npy")
...
im_name = plot_image(7000)   

Image.open('D:/ML final project/PS_Battles/dataset/'+im_name) 



# X = np.load("D:/ML final project/PS_Battles/ps-battles-ela-ds.npy")
